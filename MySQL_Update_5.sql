...
('BREWFATHER', 'BREWFATHERSUFFIX', '[SG]', 'iSpindel polynom in ... ([SG] = relative Dichte, [PL] = plato)  ', 'iSpindel polynom set for ... ([SG] = specific gravity, [PL] = plato)'),
...
('BREWFATHER', 'FAT_USE_ISPINDEL_TOKEN', '0', 'Verwendung des ISpindel Tokens zur Weiterleitung', 'Use token from iSpindel for data forwarding'),
('BREWSPY', 'SPY_USE_ISPINDEL_TOKEN', '0', 'Verwendung des ISpindel Tokens zur Weiterleitung', 'Use token from iSpindel for data forwarding');
